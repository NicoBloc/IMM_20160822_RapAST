...
```{r AUC, echo=FALSE, warning=FALSE, fig.height=8.5, results='asis'}
ggplot(dAUC, aes(x=h, y=AUC, colour=organism)) + geom_line() + geom_point() + facet_wrap(~ antibiotic) + scale_x_continuous(breaks=c(6, 8, 12, 18), minor_breaks=NULL) + theme(legend.position="top", strip.text.x=element_text(face='bold'))
```
